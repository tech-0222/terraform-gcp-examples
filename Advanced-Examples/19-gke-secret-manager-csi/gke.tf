...
resource "google_container_cluster" "primary" {
  ...
  # Installs the Secret Manager CSI driver on the nodes, which is what
  # backs the `secrets-store-gke.csi.k8s.io` volume in k8s/03-deployment.yaml.
  # Ref: https://cloud.google.com/kubernetes-engine/docs/how-to/secret-manager
