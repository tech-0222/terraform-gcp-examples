...
| [google_compute_global_address.redis_psa_range](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_global_address) | resource |
...
| [google_service_networking_connection.redis_psa](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/service_networking_connection) | resource |
...
| artifact\_registry\_repository\_id | Artifact Registry Docker repository ID. | `string` | `"tf-adv-gke-redis-repo"` | no |
| bastion\_instance\_name | Bastion VM name. | `string` | `"tf-adv-gke-redis-vm"` | no |
...
| bastion\_subnet\_name | Subnet name for the bastion VM. Kept separate from the GKE subnet so master\_authorized\_networks can allow only this range. | `string` | `"tf-adv-gke-redis-mgmt-subnet"` | no |
| cluster\_name | GKE cluster name. | `string` | `"tf-adv-gke-redis"` | no |
| gke\_subnet\_cidr | Primary CIDR of the GKE subnet. | `string` | `"10.40.0.0/24"` | no |
| gke\_subnet\_name | Subnet name for GKE nodes. | `string` | `"tf-adv-gke-redis-subnet"` | no |
...
| network\_name | VPC network name. | `string` | `"tf-adv-gke-redis-vpc"` | no |
...
| redis\_memory\_size\_gb | Redis memory size in GB. BASIC tier accepts 1-300. | `number` | `1` | no |
...
| redis\_host | Redis private IP, reachable from Pods over the GKE VPC. |
