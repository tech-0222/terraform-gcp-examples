...
variable "network_name" {
  ...
  type        = string
  default     = "tf-adv-gke-redis-vpc"
}

variable "gke_subnet_name" {
  description = "Subnet name for GKE nodes."
  type        = string
  default     = "tf-adv-gke-redis-subnet"
}
...
variable "bastion_subnet_name" {
  ...
  type        = string
  default     = "tf-adv-gke-redis-mgmt-subnet"
}
...
variable "artifact_registry_repository_id" {
  ...
  type        = string
  default     = "tf-adv-gke-redis-repo"
}

variable "redis_memory_size_gb" {
  description = "Redis memory size in GB. BASIC tier accepts 1-300."
  type        = number
  default     = 1
}
