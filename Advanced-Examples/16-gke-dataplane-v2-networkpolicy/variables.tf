...
variable "network_name" {
  ...
  type        = string
  default     = "tf-adv-gke-dpv2-vpc"
}

variable "gke_subnet_name" {
  description = "Subnet name for GKE nodes."
  type        = string
  default     = "tf-adv-gke-dpv2-subnet"
}
...
variable "bastion_subnet_name" {
  ...
  type        = string
  default     = "tf-adv-gke-dpv2-mgmt-subnet"
}
