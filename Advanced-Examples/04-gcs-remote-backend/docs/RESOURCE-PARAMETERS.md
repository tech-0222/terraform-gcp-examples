...
このファイルは **Terraform GCS Remote Backend 用バケット** について対応づけます。自動生成の `docs/PARAMETER.md` とは別物です。ネストした `demo/` は [demo/RESOURCE-PARAMETERS.md](../demo/docs/RESOURCE-PARAMETERS.md) です。
