...
variable "network_name" {
  ...
  type        = string
  default     = "tf-adv-gce-iap-vpc"
}

variable "subnet_name" {
  description = "Subnet name."
  type        = string
  default     = "tf-adv-gce-iap-subnet"
}
...
variable "iap_member" {
  description = "IAM member granted IAP tunnel + OS Login (e.g. user:you@example.com)."
  type        = string
