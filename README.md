...
| 12 | `12-bigquery` | Dataset / Table | 実装済み |
| 13 | `13-cloud-sql-postgresql` | Cloud SQL for PostgreSQL / Database | 実装済み |
| 14 | `14-cloud-kms` | KeyRing / CryptoKey | 実装済み |
| 15 | `15-cloud-monitoring` | Alert Policy / 任意のEmail Notification Channel | 実装済み |
...
| 06 | `06-cloudrun-cloudsql-postgresql` | Cloud Run + Cloud SQL PostgreSQL + Secret Manager | コード準備済み（未検証） |
